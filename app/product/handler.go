...
import (
	"context"
	"github.com/alfieTangTang/go_lushi/app/product/biz/service"
...
func (s *ProductCatalogServiceImpl) ListProducts(ctx context.Context, req *product.ListProductReq) (resp *product.ListProductsResp, err error) {
